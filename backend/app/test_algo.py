...
APR_2026_12HR_WARD_REQUESTS: list[RequestSeed] = [
    # Derived from EditedCasuarinaRoster.xlsx, sheet "6 Apr - 19 Apr".
    # Source PH/PH2/PH3/PH4 request codes are stored as HOL leave requests.
    RequestSeed("Nurse 1", date(2026, 4, 6), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 7), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 8), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 9), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 10), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 13), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 14), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 15), "AL", "leave_request"),
    RequestSeed("Nurse 1", date(2026, 4, 16), "A-12", "shift_request"),
    RequestSeed("Nurse 1", date(2026, 4, 19), "RD", "shift_request"),
    RequestSeed("Nurse 2", date(2026, 4, 14), "DO", "shift_request"),
    RequestSeed("Nurse 3", date(2026, 4, 10), "DO", "shift_request"),
    RequestSeed("Nurse 3", date(2026, 4, 11), "HOL", "leave_request"),
    RequestSeed("Nurse 4", date(2026, 4, 11), "RD", "shift_request"),
    RequestSeed("Nurse 4", date(2026, 4, 18), "RD", "shift_request"),
    ...
    RequestSeed("Nurse 7", date(2026, 4, 6), "A-12", "shift_request"),
    RequestSeed("Nurse 7", date(2026, 4, 14), "DO", "shift_request"),
    RequestSeed("Nurse 7", date(2026, 4, 15), "N-12", "shift_request"),
    RequestSeed("Nurse 8", date(2026, 4, 11), "DO", "shift_request"),
    RequestSeed("Nurse 8", date(2026, 4, 18), "DO", "shift_request"),
    RequestSeed("Nurse 9", date(2026, 4, 11), "DO", "shift_request"),
    RequestSeed("Nurse 9", date(2026, 4, 12), "RD", "shift_request"),
    RequestSeed("Nurse 9", date(2026, 4, 13), "HOL", "leave_request"),
    RequestSeed("Nurse 9", date(2026, 4, 14), "HOL", "leave_request"),
    RequestSeed("Nurse 9", date(2026, 4, 15), "HOL", "leave_request"),
    RequestSeed("Nurse 9", date(2026, 4, 16), "AL", "leave_request"),
    RequestSeed("Nurse 9", date(2026, 4, 17), "AL", "leave_request"),
    RequestSeed("Nurse 11", date(2026, 4, 6), "AL", "leave_request"),
    RequestSeed("Nurse 11", date(2026, 4, 7), "AL", "leave_request"),
    RequestSeed("Nurse 11", date(2026, 4, 8), "AL", "leave_request"),
    RequestSeed("Nurse 11", date(2026, 4, 9), "DO", "shift_request"),
    RequestSeed("Nurse 11", date(2026, 4, 10), "RD", "shift_request"),
    RequestSeed("Nurse 11", date(2026, 4, 11), "N-12", "shift_request"),
    RequestSeed("Nurse 14", date(2026, 4, 9), "AL", "leave_request"),
    RequestSeed("Nurse 14", date(2026, 4, 13), "AL", "leave_request"),
    RequestSeed("Nurse 14", date(2026, 4, 14), "AL", "leave_request"),
    RequestSeed("Nurse 14", date(2026, 4, 15), "AL", "leave_request"),
    RequestSeed("Nurse 14", date(2026, 4, 16), "DO", "shift_request"),
    RequestSeed("Nurse 14", date(2026, 4, 17), "N-12", "shift_request"),
    RequestSeed("Nurse 14", date(2026, 4, 18), "N-12", "shift_request"),
    RequestSeed("Nurse 16", date(2026, 4, 15), "DO", "shift_request"),
    RequestSeed("Nurse 18", date(2026, 4, 11), "DO", "shift_request"),
    RequestSeed("Nurse 18", date(2026, 4, 15), "DO", "shift_request"),
    RequestSeed("Nurse 20", date(2026, 4, 7), "DO", "shift_request"),
    RequestSeed("Nurse 20", date(2026, 4, 8), "HOL", "leave_request"),
    RequestSeed("Nurse 20", date(2026, 4, 8), "BDL", "leave_request"),
]
