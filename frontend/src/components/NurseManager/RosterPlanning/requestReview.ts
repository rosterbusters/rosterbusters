...
import type { RosterRow, ShiftRequestOverlay } from "@/components/NurseManager/RosterTable";
...
export function buildShiftRequestOverlays(
  ...
  for (const row of review.rows) {
    const status: ShiftRequestOverlay["status"] = row.matched ? "Approved" : "Rejected";
