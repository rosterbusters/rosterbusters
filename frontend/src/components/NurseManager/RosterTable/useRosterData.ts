  ...
  return useQuery<Ward[]>({
    ...
    queryFn: async () => {
      ...
      return data.map((w: Record<string, unknown>) => ({
        ...
        am_rn: w.am_rn ?? null,
        am_en_na_min: w.am_en_na_min ?? null,
        am_en_na_max: w.am_en_na_max ?? null,
        am_hca_min: w.am_hca_min ?? null,
        am_hca_max: w.am_hca_max ?? null,
        pm_total: w.pm_total ?? null,
        pm_rn: w.pm_rn ?? null,
        pm_en_na_min: w.pm_en_na_min ?? null,
        pm_en_na_max: w.pm_en_na_max ?? null,
        pm_hca_min: w.pm_hca_min ?? null,
