...
// ---------------------------------------------------------------------------
// Configuration — notification types NM can toggle
// ---------------------------------------------------------------------------
const NM_TOGGLEABLE_NOTIFICATIONS: {
  label: string
  types: string[]
  description: string
}[] = [
  ...
  },
  {
    ...
    types: ["RosterFinalisation"],
    description: "Get a reminder about the roster publish deadline.",
  },
  {
    label: "HRIS Open",
